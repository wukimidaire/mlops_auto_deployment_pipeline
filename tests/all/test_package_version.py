...
class TestPackageVersion(TestBase):
    ...
    def test_package_version(self):
        ...
        assert "automate_model_lifecycle" in package_summary, "the `taxifare` package version is not correct, please run `make reinstall_package` to reinstall the package"
